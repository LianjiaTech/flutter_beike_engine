...
void Snapshot::GenerateAppAOTAsAssembly(const char* snapshot_filename) {
  ...
  Dart_Handle result = Dart_CreateAppAOTSnapshotAsAssembly(&vm_snapshot_data_buffer, &vm_snapshot_data_size,&isolate_snapshot_data_buffer, &isolate_snapshot_data_size,
